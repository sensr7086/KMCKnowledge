...
## 4 ~ 5 깊이 자료 — [`deep/AssetLoadingDeep.md`](./deep/AssetLoadingDeep.md) ✂️

> **Article 3 Level 3 progressive disclosure 적용** — 메인 슬림화 + 깊이 자료 별도.

| § | 내용 | reference 위치 |
|---|------|----------------|
| 4 | **FStreamableManager API** — RequestAsyncLoad / RequestSyncLoad + FStreamableHandle 8 메소드 + Pin/Release 생명주기 + 우선순위 | [`§1`](./deep/AssetLoadingDeep.md#1-fstreamablemanager--비동기-로드-표준-api) |
| 5 | **UAssetManager Primary Asset + Bundle** — UPrimaryDataAsset / FPrimaryAssetId / LoadPrimaryAsset / Bundle 시스템 / PreloadPrimaryAssets / DefaultEngine.ini 자동 스캔 | [`§2`](./deep/AssetLoadingDeep.md#2-uassetmanager--primary-asset--bundle-시스템-preload-표준) |
...
## 7. PreLoadAsset 정책 — [`deep/AssetLoadingDeep.md §3`](./deep/AssetLoadingDeep.md#3-preloadasset-정책--5대-의무) ✂️
...
## 9. 함정 & 안티패턴 — [`deep/AssetLoadingDeep.md §4`](./deep/AssetLoadingDeep.md#4-함정--안티패턴-12종) (12종)
...
## 11. sub-skill 적용 매트릭스 — [`deep/AssetLoadingDeep.md §5`](./deep/AssetLoadingDeep.md#5-sub-skill-적용-매트릭스-14종) (14종)
